 ...
 * @LastEditTime: 2021-01-12 11:16:37
      ...
      <el-card class="box-card">
        ...
        <el-dialog title="编辑商品" :visible.sync="dialogVisible">
          <el-form
              ...
              <el-form-item label="商品价格" prop="goods_name" :label-width="formLabelWidth">
                <el-input
                style="width:400px"
              ...
              <el-form-item label="商品数量" prop="goods_name" :label-width="formLabelWidth">
                <el-input
                style="width:400px"
              ...
              <el-form-item label="商品重量" prop="goods_name" :label-width="formLabelWidth">
                <el-input
                style="width:400px"
