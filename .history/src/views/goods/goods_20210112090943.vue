 ...
 * @LastEditTime: 2021-01-12 09:09:43
        ...
        <div class="box">
          <el-card class="box-card">
            <el-table :data="roles" style="width: 100%">
              ...
              <el-table-column prop="roleDesc" label="商品价格（元）" align="center" width="250"> </el-table-column>
              <el-table-column prop="roleDesc" label="商品重量" align="center" width="250"> </el-table-column>
              <el-table-column prop="roleDesc" label="创建时间" align="center" width="250"> </el-table-column>
