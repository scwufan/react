 ...
 * @LastEditTime: 2021-01-12 15:37:22
          ...
          <el-dialog title="添加分类" :visible.sync="dialogFormVisible">
            <el-form
              ...
              <el-form-item label="分类名称" prop="cat_name" :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="forms" autocomplete="off"></el-input>
              </el-form-item>
            </el-form>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      this.forms = this.categories[index];
