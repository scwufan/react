 ...
 * @LastEditTime: 2021-01-13 17:41:21
  ...
  <div class="all">
    <div class="all_box">
      <el-card class="box-card">
          ...
          <el-dialog title="添加分类" :visible.sync="dialogFormVisible">
            <el-form
              ...
              <el-form-item label="分类名称" prop="cat_name"  :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="addform.roleName" autocomplete="off"></el-input>
              </el-form-item>
            </el-form>
            <div class="cascader">
              <div>父级分类</div>
        ...
        <div class="box">
          <el-card class="box-card">
            <el-table :data="categories.slice((currentPage - 1) * pageSize, currentPage * pageSize)" style="width: 100%" row-key="cat_id">
              <el-table-column label="#" width="50" type=""> 
                <template slot-scope="scope">
                  <span>{{ scope.$index.length }}</span>
                </template>
              </el-table-column>
              <el-table-column prop="cat_name" label="分类名称" width="350">
              </el-table-column>
              <el-table-column label="是否有效" align="center" width="200">
                <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...categorieActions(["getCategoriesList", "deleteCategories", "editCategories"]),
    changes(val) {
      console.log(val)
    },
    //编辑用户
    ...
    handleDelete(index, row) {
      this.$confirm("永久删除该文件, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          this.deleteCategories(row.cat_id);
          this.getCategoriesList({
            query: "",
            pagenum: this.pagenum,
            pagesize: this.pagesize,
