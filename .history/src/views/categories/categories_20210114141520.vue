 ...
 * @LastEditTime: 2021-01-14 14:15:20
...
export default {
  ...
  methods: {
    ...categorieActions(["getCategoriesList", "deleteCategories", "editCategories", "addCategories"]),
    //添加分类
    handleChange(val) {
      console.log(val)
    },
    update1() {
      this.addCategories({
       cat_pid: this.arrs.cat_id,
       cat_name: this.addform.roleName,
