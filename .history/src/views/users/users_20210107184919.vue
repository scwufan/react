 ...
 * @LastEditTime: 2021-01-07 18:49:19
                    ...
                    <el-dialog title="编辑用户" :visible.sync="dialogFormVisible1">
                      <el-form
                        ...
                        <el-form-item disabled label="用户名" prop="username" :label-width="formLabelWidth">
                          <el-input disabled style="width:400px" v-model="form.username" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="邮箱" prop="email" :label-width="formLabelWidth">
                          <el-input style="width:400px" v-model="form.email" autocomplete="off"></el-input>
                        </el-form-item>
                  ...
                  <el-button
                    ...
                    <el-dialog title="分配用户" :visible.sync="dialogFormVisible2">
                      ...
                      <div slot="footer" class="dialog-footer">
                        <el-button @click="dialogFormVisible1 = false">取 消</el-button>
                        <!-- 设置触发更新的方法 -->
                        <el-button type="primary" @click="handleDistribution">确 定</el-button>
                      </div>
                    </el-dialog>
                </template>
              </el-table-column>
