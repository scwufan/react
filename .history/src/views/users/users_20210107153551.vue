 ...
 * @LastEditTime: 2021-01-07 15:35:51
          ...
          <el-dialog title="收货地址" :visible.sync="dialogFormVisible">
            <el-form
              ...
              <el-form-item label="用户名" prop="username" :label-width="formLabelWidth">
                <el-input style="width:200px" v-model="form.username" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="密码" prop="password" :label-width="formLabelWidth">
                <el-input style="width:200px" v-model="form.password" autocomplete="off"></el-input>
              </el-form-item>
