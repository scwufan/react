 ...
 * @LastEditTime: 2021-01-08 08:57:18
          ...
          <el-dialog title="添加用户" :visible.sync="dialogFormVisible">
            <el-form
              ...
              <el-form-item label="密码" prop="password" :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="ruleForm.password" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="邮箱" prop="email" :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="ruleForm.email" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="手机号" prop="mobile" :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="ruleForm.mobile" autocomplete="off"></el-input>
              </el-form-item>
            </el-form>
                    ...
                    <el-dialog title="编辑用户" :visible.sync="dialogFormVisible1">
                      <el-form
                        ...
                        <el-form-item disabled label="用户名" prop="usernames" :label-width="formLabelWidth">
                          <el-input disabled style="width:400px" v-model="ruleForm.usernames" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="邮箱" prop="email" :label-width="formLabelWidth">
                          <el-input style="width:400px" v-model="ruleForm.email" autocomplete="off"></el-input>
                        </el-form-item>
...
export default {
  ...
  methods: {
    ...userActions(["getUsers", "addUser", "deleteUser", "changeUser", "editUser", "distributionUser"]),
    //增加用户
    addUsers() {
      this.addUser({
