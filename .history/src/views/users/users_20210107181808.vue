 ...
 * @LastEditTime: 2021-01-07 18:18:08
          ...
          <el-dialog title="添加用户" :visible.sync="dialogFormVisible">
            <el-form
              ...
              <el-form-item label="用户名" prop="user" :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="form.user" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="密码" prop="pass" :label-width="formLabelWidth">
                <el-input style="width:400px" v-model="form.pass" autocomplete="off"></el-input>
              </el-form-item>
                  ...
                  <el-button
                    ...
                    <el-dialog title="编辑用户" :visible.sync="dialogFormVisible1">
                      <el-form
                        ...
                        :rules="rules"
                        ref="form">
                        <el-form-item disabled label="用户名" prop="user" :label-width="formLabelWidth">
                          <el-input disabled style="width:400px" v-model="form.user" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="邮箱" prop="email" :label-width="formLabelWidth">
                          <el-input style="width:400px" v-model="form.email" autocomplete="off"></el-input>
                        </el-form-item>
...
export default {
  ...
  methods: {
    ...userActions(["getUsers", "addUser", "deleteUser", "changeUser", "editUser"]),
    //增加用户
    addUser() {
      this.addUser({
    ...
    handleEdit(index, row) {
      this.editUser({
        id: row.form.id,
        email: row.form.email,
        mobile: row.form.mobile
      });
