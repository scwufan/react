        ...
        <div class="box">
          <el-card class="box-card">
            <el-table :data="roles" style="width: 100%">
              ...
              <el-table-column prop="roleName" label="职位" align="center" width="300"> </el-table-column>
              <el-table-column prop="roleDesc" label="描述" align="center" width="300"> </el-table-column>
