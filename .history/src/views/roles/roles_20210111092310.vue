                  ...
                  <div v-else>
                    <div v-for="(item,index) in scope.row.children" :key="index" class="scope_a">
                        ...
                        <div v-for="(itema,index) in item.children" :key="index" class="scope_b">
                            ...
                            <div class="scope_d">
                            <div v-for="(itemb,index) in item.children" :key="index" class="scope_c" @click="handleDelete(scope.$index, scope.row)">
                                <el-tag closable type="warning">{{ itemb.authName }}</el-tag>
                            </div>
                            </div>
                        </div>
                        </div>
...
export default {
  ...
  methods: {
    ...roleActions(["rolesList", "addRoles", "deleteRoles", "editRoles", "deleteRolesPower"]),
    //增加用户
    addRole() {
      this.addRoles({
