        ...
        <div class="box">
          <el-card class="box-card">
            <el-table :data="roles" style="width: 100%">
              ...
              <el-table-column prop="roleName" label="职位" align="center" width="250"> </el-table-column>
              <el-table-column prop="roleDesc" label="描述" align="center" width="250"> </el-table-column>
...
export default {
  ...
  methods: {
    ...roleActions(["rolesList", "addRoles", "deleteRoles", "editRoles", "deleteRolesPower", "powerList", "queryReports"]),
    //增加用户
    addRole() {
      this.addRoles({
  ...
  watch: {},
  computed: {
    ...roleState(["roles", "roles2", "reports"]),
  },
};
</script>
