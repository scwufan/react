 ...
 * @LastEditTime: 2021-01-06 17:31:34
        ...
        <el-aside width="200px">
          <el-col :span="24">
            ...
            >
              ...
              <el-submenu v-for="(item, index) in menus" :key="item.id" :index="item.path">
                <template>
                  <span slot="title">{{ item.authName }}</span>
                </template>
                <el-menu-item-group v-for="(itema, index) in item.children" :key="item.id">
