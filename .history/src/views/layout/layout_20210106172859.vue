 ...
 * @LastEditTime: 2021-01-06 17:28:59
        ...
        <el-aside width="200px">
          <el-col :span="24">
            ...
            >
              ...
              <el-submenu v-for="(item, index) in menus" :key="index" :index="item.id.toString()">
                <template>
                  <span slot="title">{{ item.authName }}</span>
                </template>
                <el-menu-item-group>
                  <el-menu-item :index="itema.id.toString()" v-for="(itema, index) in item.children" :key="index">
