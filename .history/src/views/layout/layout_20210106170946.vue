 ...
 * @LastEditTime: 2021-01-06 17:09:46
        ...
        <el-aside width="200px">
          <el-col :span="24">
            ...
            >
              ...
              <el-submenu :index="item.path" v-for="(item, index) in menus" :key="index" index="/">
                <span slot="title">{{ item.authName }}</span>
                <el-menu-item :index="itema.path" v-for="(itema, index) in item.children" :key="index">
